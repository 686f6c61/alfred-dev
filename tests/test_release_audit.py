...
class TestReleaseAuditScript(unittest.TestCase):
    ...
    def test_public_claims_do_not_drift_from_current_inventory(self):
        ...
        self.assertIn("README, landing, arquitectura, help y agentes sin contadores antiguos", result)
        self.assertIn("displayName humano reflejado en README, changelog y landing", result)
