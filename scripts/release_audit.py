...
def check_command_catalog() -> list[str]:
    ...
    if help_text.count("Si la ayuda se pide dentro de un proyecto real") != 1:
...
def check_public_claims() -> list[str]:
    ...
    site_es = _read("site/src/i18n/data.es.ts")
    site_en = _read("site/src/i18n/data.en.ts")
    site_component = _read("site/src/components/BrutalistLandingPage.astro")
    ...
    sources = {
        ...
        "site/src/i18n/data.es.ts": site_es,
        "site/src/i18n/data.en.ts": site_en,
    }
    missing: list[str] = []
    ...
    stale_sources = {
        ...
        "site/src/i18n/data.es.ts": site_es,
        "site/src/i18n/data.en.ts": site_en,
        "site/src/components/BrutalistLandingPage.astro": site_component,
...
def check_flow_gate_claims() -> list[str]:
    ...
    public_gate_requirements = {
        ...
        "site/src/i18n/data.en.ts": ("quality gates that require evidence before work can close",),
    }
    ...
    public_gate_stale = {
        ...
        "site/src/i18n/data.en.ts": ("quality gates the workflow cannot skip",),
    }
