...
```bash
python3 .claude/alfred-continuity.py check-project-docs "$PWD" --command ship --phase documentacion
```
...
```bash
python3 .claude/alfred-continuity.py hygiene "$PWD" --command ship
```
